  ...
  container.innerHTML = `
    <aside class="sidebar">
      <div class="sidebar-header">
        <div class="sidebar-title" id="sidebar-gp-name">Gram Panchayat</div>
        <div class="sidebar-sub">Home Tax Reminders</div>
      </div>
      <nav class="sidebar-nav">
        ${linksHtml}
      </nav>
      <div class="sidebar-footer">
        <div class="sidebar-version">v1.0 • Eel Local Desktop</div>
      </div>
    </aside>
  `;

  // Load GP Office Name into sidebar
  if (window.eel) {
    eel.get_all_app_settings()((settings) => {
      const el = document.getElementById("sidebar-gp-name");
      if (el && settings.gram_panchayat_name) {
