...
Comprehensive test suite for all home_tax_reminder backend services and algorithms.
"""
...
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "home_tax_reminder")))
