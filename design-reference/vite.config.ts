...
const siteConfiguration = JSON.parse(readFileSync(new URL('./.figma/make/site.json', import.meta.url), 'utf8')) as FigmaSiteConfiguration
...
export default defineConfig(({ mode }) => {
  ...
  return {
    ...
    plugins: [
      react(),      figmaSiteConfiguration(siteConfiguration),
